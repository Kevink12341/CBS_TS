...
export const create_db_variables = (xml_input) => {
    ...
    let sql_create_db = `CREATE TABLE ${cbsTableName} (${column_string})`;
    console.log(sql_create_db);
};
//# sourceMappingURL=Create_table_from_link.js.map