...
let compareString: string[] = String(cbs_link_4).split("/")
function sort_data(compareString:string[]) {
    let string_data = ""
...
function compare_db_to_string(db_data:string, string_data:string) {
    let new_string_data =""
